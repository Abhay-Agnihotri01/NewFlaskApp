...
# render_template - it is used to render HTML web templates.
# request - it is used to access the incoming request data.
import requests
from urllib.parse import unquote # unquote - is used for URL decoding

# Create the flask app
app = Flask(__name__)

# Replace with your Spoonacular API key
API_KEY = '06c12aff9d4f464a81ace907ebb3967d'
